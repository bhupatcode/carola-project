...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_FILES["aadhar_file"]) && $_FILES["aadhar_file"]["error"] == 0) {
        $aadhar_file_name = $_SESSION["userid"] ."_ ".time() . "_aadhar_" . basename($_FILES["aadhar_file"]["name"]);
    ...
    if (isset($_FILES["license_file"]) && $_FILES["license_file"]["error"] == 0) {
        $license_file_name =  $_SESSION["userid"] ."_ ".time() . "_license_" . basename($_FILES["license_file"]["name"]);
