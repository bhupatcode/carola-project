        ...
        <div class="footer-container">
            ...
            <div class="footer-section community">
                ...
                <ul style=" list-style: none;">
                    ...
                    <li style=" margin-bottom: 10px;"><a class="a" href="Testimonials.php">Testimonials</a></li>
                     <li style=" margin-bottom: 10px;"><a class="a" href="camera.html">Capture</a></li>
                </ul>
            </div>
            <!-- Resources -->
            <div class="footer-section resources">
                ...
                <ul style=" list-style: none;">
                    ...
                    <li style=" margin-bottom: 10px;"><a class="a" href="our_team.php">Our Team</a></li>
                    ...
                    <li style=" margin-bottom: 10px;"><a class="a" href="contacts.html">Contacts</a></li>
                    <li style=" margin-bottom: 10px;"><a class="a" href="https://carolabm.infinityfreeapp.com/admin/index.php">Admin</a></li>
