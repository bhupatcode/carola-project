...
<body>
    ...
    <div class="profile-header">
        ...
        <img src="image/i2.jpg" alt="Background" class="background-image">
    ...
    <div class="services-section">
        ...
        <a href="my_booking.php" target="main">
            <div class="service-card">
    ...
    <iframe src="info.php" name="main" id="main" onload="resizeIframe(this)"></iframe>
