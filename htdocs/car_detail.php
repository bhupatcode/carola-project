    ...
    if (empty($errors)) {
        ...
        if ($driverAvailable && $carAvailable) {
            ...
            if (!($userresult['aadhar_number']) && !($userresult['aadhar_file']) && !($userresult['license_number']) && !($userresult['license_file'])) {
                ...
                header("Location: http://carolabm.infinityfreeapp.com/booking_confirmation.php");
            }
            exit();
        ...
        <div class="page-container">
            <div class="container">
                <div class="car-image" id="carImage">
                    ...
                    <img src="admin/<?php echo $image[0]; ?>" alt="Not " id="mainImg">
                    <div class="image-slider">
                        <img class="slide" src="admin/<?php echo $image[0]; ?>" alt="Car Interior Front" id="thumb1">
                        <img class="slide" src="admin/<?php echo $image[1]; ?>" alt="Car Interior Back" id="thumb2">
                        <img class="slide" src="admin/<?php echo $image[2]; ?>" alt="Car Interior Back" id="thumb3">
    ...
    <div class="fleet" id="fleet-container">
        ...
        ?>
                <div class="card" data-name="<?php echo strtolower($rowroc['cname']); ?>">
                    <img class="rec" src="admin/<?php echo $image1[0] ?>" alt="Car Image">
