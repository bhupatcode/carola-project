    ...
    <div class="form-container">
        ...
        <form action="" method="post">
            ...
            <div class="form-group">
                ...
                <input type="date" id="dob" name="dob" value="<?php echo $result['DOB'] ?? ''; ?>" disabled>
            </div>
            ...
            <div class="form-group">
                ...
                <select id="address_type" name="address_type" disabled>
            ...
            <div class="form-group">
                ...
                <input type="number" id="pincode" name="pincode" placeholder="Enter PinCode" value="<?php echo $result['pincode'] ?? ''; ?>" disabled>
            </div>

            <div class="form-group">
                <label for="address">Address</label>
                <input type="text" id="address" name="address" value="<?php echo $result['address'] ?? ''; ?>" disabled>
            </div>
