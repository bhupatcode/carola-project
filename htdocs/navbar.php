...
<body>
  <header class="navbar">
    <div class="logo">
      <a href="index.php"> <span class="logo-text">Car<span style="color: red;">ola</span></span></a>
    </div>
    <nav class="nav-links">
...
setInterval(loadNotifications, 60 * 60 * 1000); // 1 hour (60 minutes * 60 seconds * 1000 milliseconds)
