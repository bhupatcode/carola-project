...
if (isset($_POST['submit'])) {
    ...
    if ($count == 0) {
        ...
        if (!empty($_FILES['rcbook']['name'])) {
            $rcbook_target = "upload/car-image/" . $_FILES['rcbook']['name'];
        ...
        if (!empty($_FILES['insurance']['name'])) {
            $insurance_target = "upload/car-image/" . $_FILES['insurance']['name'];
        ...
        // Handle image uploads separately for each input field
        for ($i = 0; $i < 3; $i++) {
            $inputName = "image" . ($i + 1); // Assuming input names are image1, image2, image3

            if (!empty($_FILES[$inputName]['name'])) {
                $target = "upload/car-image/" . $_FILES[$inputName]['name'];

                if (move_uploaded_file($_FILES[$inputName]['tmp_name'], $target)) {
                    $existingImages[$i] = $target;  // Replace only the uploaded image
                }
            }
        }
...
<head>
    ...
    <link rel="stylesheet" href="css/update_car_style.css">
    ...
    <div class="container">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="car_details">
                ...
                <div class="fual-type">
                    ...
                    <select name="fual" id="fual">
                        ...
                        <option value="EV" <?php if ($result['fual'] == 'EV') {
                                                echo "selected";
                                            } ?>>EV</option>
                    </select>
                ...
                <div class="up-img">
                    ...
                    <div id="imagePreview1">
                        <?php if (!empty($storedImages[0])) { ?>
                            <img src="<?php echo $storedImages[0]; ?>" style="max-width:100px; margin:10px;">
                        <?php } ?>
                    </div>
                </div>
                ...
                <div class="up-img">
                    ...
                    <div id="imagePreview2">
                        <?php if (!empty($storedImages[1])) { ?>
                            <img src="<?php echo $storedImages[1]; ?>" style="max-width:100px; margin:10px;">
                        <?php } ?>
                    </div>
                </div>
                ...
                <div class="up-img">
                    ...
                    <div id="imagePreview3">
                        <?php if (!empty($storedImages[2])) { ?>
                            <img src="<?php echo $storedImages[2]; ?>" style="max-width:100px; margin:10px;">
                        <?php } ?>
                    </div>
                </div>
                ...
                <div class="up-img">
                    ...
                    <?php if (!empty($old_rcbook_pdf)): ?>
                        <div>Rc Book :<a href="<?php echo $old_rcbook_pdf; ?>" target="_blank">View Rc Book</a></div>
                    <?php endif; ?>
                </div>
                ...
                <div class="up-img">
                    ...
                    <?php if (!empty($old_insurance_pdf)): ?>
                        <div>Current Insurance :<a href="<?php echo $old_insurance_pdf; ?>" target="_blank">View Insurance File</a></div>
                    <?php endif; ?>
                </div>
            ...
            <div class="accessories">
                <div class="select-box" style="margin-bottom:0px; margin-top:-30px;">
                ...
                <div class="select-box" style="margin-bottom:0px; margin-top:-30px;">
                    ...
                    <input type="text" style="width:90%;" name="fual-tank" id="fual-tank" placeholder="Enter Fual Capacity" value="<?php echo $result['fual_capacity']; ?>">
                ...
                <div class="select-box" style="margin-bottom:0px; margin-top:-30px;">
                    ...
                    <input type="text" style="width:90%;" name="engine-power" id="engine-power" placeholder="Enter Engine Power" value="<?php echo $result['en_power']; ?>">
