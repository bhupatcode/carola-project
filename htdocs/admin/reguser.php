...
$search_query = "";
if (!empty($search)) {
    $search_query = " AND (name LIKE '%$search%' OR email LIKE '%$search%' OR mnumber LIKE '%$search%')";
}

// Fetch Users with Pagination and Search
$sql = "SELECT * FROM reguser WHERE deleted_at IS NULL $search_query LIMIT $start, $limit";
$result = mysqli_query($conn, $sql);

// Total Records Count for Pagination
$total_result = mysqli_query($conn, "SELECT COUNT(*) AS total FROM reguser WHERE deleted_at IS NULL $search_query");
