...
$sql = "SELECT * FROM booking WHERE  DATE(FromDate)='$todaydate'  LIMIT $start, $limit";
$result = mysqli_query($conn, $sql);

// Total Cars for Pagination Count
$total_result = mysqli_query($conn, "SELECT COUNT(*) AS total FROM booking WHERE DATE(FromDate)='$todaydate'");
...
<head>
    ...
    <title>Today  Pick  Booking Car</title>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo $status_labels[$row['status']];?> </td>
