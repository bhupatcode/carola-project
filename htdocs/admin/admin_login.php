...
if(isset($_POST['submit']))
{
    ...
    else
    {
        ...
        {
            $pass1="Enter At least 8 characters !";
            $count++;
        }
    }
    ...
    <div class="login-container">
        ...
        <form action="" method="POST">
            ...
            <i class="fa fa-lock"></i>
                ...
                <p style="color: red;"><?php echo $pass1; ?></p>
            </div>

            <button type="submit" class="login-btn" name="submit">Login</button>
            <a href="forgot/aforgot_password.php" class="forgot-password">Forgot Password?</a>
        </form>
    </div>
</body>
</html>