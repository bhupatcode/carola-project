...
if (isset($_POST['submit'])) {
    ...
    if ($count== 0) {
        $imagePaths = [];
        $sanitizedCarName = preg_replace('/[^A-Za-z0-9]/', '_', strtolower($car_name)); // Special chars replace
    
        foreach ($_FILES as $inputName => $file) {
            if (isset($file['name']) && is_array($file['name'])) {
                $location = "upload/car-image/";
                if (!is_dir($location)) {
                    mkdir($location, 0777, true);
                }
    
                foreach ($file['name'] as $key => $val) {
                    $fileExt = pathinfo($val, PATHINFO_EXTENSION);
                    $newFileName = $sanitizedCarName . "_" . uniqid() . "." . $fileExt;
        ...
        if (!empty($_FILES['rcbook']['name'])) {
            $rcExt = pathinfo($_FILES['rcbook']['name'], PATHINFO_EXTENSION);
            $rcBookPath = "upload/car-image/" . $sanitizedCarName . "_rcbook." . $rcExt;
            move_uploaded_file($_FILES['rcbook']['tmp_name'], $rcBookPath);
        }
        if (!empty($_FILES['insurance']['name'])) {
            $insExt = pathinfo($_FILES['insurance']['name'], PATHINFO_EXTENSION);
            $insurancePath = "upload/car-image/" . $sanitizedCarName . "_insurance." . $insExt;
        ...
        if (count($imagePaths) > 0) {
            ...
            VALUES ('$car_name', $modal, $chprice, $rent_price, '$no_plate', '$brand', '$imagePathsString', $seat, '$fual', $door, '$power', '$engine', '$break', $f_tank, $mile, '$accessories_list', '$rcBookPath', '$insurancePath')";
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="car_details">
                ...
                <div class="fual-type">
                    ...
                    <p style="color: red;margin-top:-21px;"><?php echo $fu; ?></p>
            ...
            <div class="accessories">
                <div class="select-box">
                    ...
                    <p style="color: red;margin-top:-21px;"><?php echo $dr; ?></p>

                </div>
                <div class="select-box">
                    
                    <span class="details">Select Fual Capacity :</span>
                    <input type="text" style="width:90%;"name="fual-tank" id="fual-tank" placeholder="Enter Fual Capacity" value="<?php echo $fual; ?>">
                    ...
                    <p style="color: red;margin-top:-21px;"><?php echo $ft; ?></p>
                ...
                <div class="select-box">
                    ...
                    <p style="color: red;margin-top:-21px;"><?php echo $br; ?></p>
                ...
                <div class="select-box">
                    ...
                    <p style="color: red;margin-top:-21px;"><?php echo $et; ?></p>

                </div>
                <div class="select-box">
                   
                    <span class="details">Select Engine Power : </span>
                    <input type="text" style="width:90%;"name="engine-power" id="engine-power" placeholder="Enter Engine Power" value="<?php echo $power; ?>">
                    ...
                    <p style="color: red;margin-top:-21px;"><?php echo $pr; ?></p>
            ...
            <p style="color: red;margin-top:-21px;margin-left:100px;"><?php echo $ml; ?></p>
