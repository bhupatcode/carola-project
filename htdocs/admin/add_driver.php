...
if (isset($_POST['submit'])) {
    ...
    if ($type_licence == "type") $errors['licence'] = "select a valid license type.";
        ...
        if (!empty($_FILES[$field]['name'])) {
            ...
            if ($fileType != 'pdf') {
                ...
                if (move_uploaded_file($_FILES[$field]['tmp_name'], $filePath)) {
                    $$field = $filePath; // Assign to the corresponding variable dynamically
                } else {
    ...
    <div class="container">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="car_details">
                ...
                <div class="fual-type">
                    <span class="details">Select Licence Type </span>
                    <select name="licence" id="fual" style="width:240px; margin-right:-30px; margin-bottom:0px;">
                    ...
                    <span class="er" style="display:flex;"> <?php echo $errors['licence']; ?></span><br>
