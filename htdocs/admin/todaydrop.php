...
$sql = "SELECT * FROM booking WHERE  DATE(ToDate)='$todaydate'  LIMIT $start, $limit";
$result = mysqli_query($conn, $sql);

// Total Cars for Pagination Count
$total_result = mysqli_query($conn, "SELECT COUNT(*) AS total FROM booking WHERE DATE(ToDate)='$todaydate'");
...
<head>
    ...
    <title>Today  Return Booking Car</title>
...
<body>
    <div class="container">
        <h1>Today  Return Booking Car</h1>
