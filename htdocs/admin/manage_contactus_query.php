...
$sql = "SELECT * FROM contactusquery WHERE deleted_at IS NULL ORDER BY PostingDate DESC LIMIT $start, $limit";
$result = mysqli_query($conn, $sql);

// Total Cars for Pagination Count
$total_result = mysqli_query($conn, "SELECT COUNT(*) AS total FROM contactusquery WHERE deleted_at IS NULL");
