...
<body>
    ...
    <div class="container">
        <img src="<?php echo $image[0]; ?>" alt="<?php echo $car['cname']; ?>" class="car-image">
        <h2><?php echo $car['cname']; ?></h2>

        <div class="btn-container">
        <a href="<?php echo $car['rcbook']; ?>" target="_blank" class="btn">View Rc File</a>
        <a href="<?php echo $car['insurance']; ?>" target="_blank" class="btn">View Insurance File</a>
