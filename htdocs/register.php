...
if(isset($_POST["sign-up"]))
{
    ...
    if ($exstmt1) {
        ...
        try {
            ...
            $mail->Password = 'xiysjnbhlejdkyok'; // Use an app password
            $mail->SMTPSecure = 'tls';
            $mail->Port = 587;
            ...
            $mail->Body    = "
                ...
                Click the link below to verify your account: <br>
                 <a href='http://carolabm.infinityfreeapp.com/verify_user.php?token=$token&email=$email'>BM Verify Email</a><br> 
            ...
            $mail->send();
            echo "<script>alert('Verification Link Sent To Your Email!');window.location.href='http://carolabm.infinityfreeapp.com/login.php';</script>";
        } catch (Exception $e) {
