...
<body>
    ...
    <div class="container">
        <h2>Change Your Booking Date</h2>
        <form action="process_modify.php" method="POST" onsubmit="return validateForm()">
            <input type="hidden" name="booking_id" value="<?= $booking['id'] ?>">

            <label style="margin-right: 225px;font-size:16px;">New Start Date:</label>
            <input type="date" id="new_start_date" name="new_start_date" required><br>

            <label style="margin-right: 230px;font-size:16px;">New End Date:</label>
